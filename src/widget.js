...
var css = [
  ...
  '.krw-text{position:absolute;left:44.25%;top:37%;transform:translate(-50%,-50%);text-align:center;color:' + C_TEXT + ';line-height:1.15;white-space:nowrap;pointer-events:none;opacity:0;transition:opacity .16s ease,transform .3s ease}',
  ...
  '.krw-label{font-size:calc(var(--krw-u) * 60);font-weight:600;letter-spacing:.06em;color:' + C_SUB + '}',
  '.krw-amount{font-size:calc(var(--krw-u) * 120);font-weight:800;line-height:1.05;color:' + C_TEXT + ';text-shadow:0 0 12px rgba(213,220,240,.35)}',
  '.krw-period{font-size:calc(var(--krw-u) * 96);font-weight:800;line-height:1.05}',
  '.krw-hint{font-size:calc(var(--krw-u) * 52);color:' + C_SUB + ';letter-spacing:.02em;margin-top:calc(var(--krw-u) * 10);min-height:calc(var(--krw-u) * 60);line-height:1.15}',
  '.krw-wrap{white-space:normal;max-width:calc(var(--krw-u) * 540);line-height:1.25}',
  // 额度进度条（画在气泡文字区里）
  '.krw-bar{width:calc(var(--krw-u) * 460);height:calc(var(--krw-u) * 22);margin:calc(var(--krw-u) * 12) auto 0;border-radius:calc(var(--krw-u) * 11);background:rgba(154,143,208,.22);overflow:hidden}',
